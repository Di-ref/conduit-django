...
class Profile(TimestampedModel):
    ...
    # A timestamp representing when this object was created. (replaced by Timestampedmodels)
    #created_at = models.DateTimeField(auto_now_add=True)

    # A timestamp reprensenting when this object was last updated. (replaced by Timestampedmodels)
